...
const percentOf = function (num1, num2) {
  percentResult = (Math.floor((num1 / num2) * 100));
...
//PART 2 ANSWERS
const calculateAll = function (num) {
  result = halfNumber(num);
  num.result = squareNumber(num);
  let squared = this.result
  num.result = areaOfCircle(num);
  num.result = percentOf(num, squared);
