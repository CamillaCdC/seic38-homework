...
// const planTrip = ( 'N', 'Times Square', '6', '33rd' )
...
const planTrip = function ( line, startStation, stopLine, endStation ) {
  ...
  if ( startLine === endLine ) {
    ...
    if ( startIndex < endIndex ) {
      // line forward
      stops = startLine.slice( startIndex, endIndex + 1);
    } else {
      // line - backwards
      stops = startLine.slice( endIndex, startIndex + 1).reverse();
    }
    ...
    let stopStage1 = [ ];
    let stopStage2 = [ ];
    let startLineIntersectingIndex = startLine.indexOf( 'Union Square' );
    ...
    stops = stopStage1.concat( stopStage2 );
  }
    // console.log(stops);
};
...
// console.log( startLineIntersectingIndex, endLineIntersectingIndex );
// console.log( stopStage1 );
// stopStage2 = endLine.slice( endLineIntersectingIndex + 1 , endIndex + 1 );
// console.log( stopStage2 );
// console.log( endLineIntersectingIndex, endIndex );
// console.log( stops );




    // console.log( startLine, startIndex, endLine, endIndex );// Because the startIndex and endIndex has already been found by the method of .indexOf, you would then console.log the keys ONLY to return a list.
    //
    //
    // stops = stops.reverse(); // .reverse() reverses an array in place. A method that doesnt requires anything between the ().
    // console.log( stops );
...
//     } else {
//       // transfer trip.
//       stops = startLine.slice( startIndex, endIndex + 1).reverse();
//     }
